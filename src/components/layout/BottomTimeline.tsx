...
import type { Shot, ConsistencyReport } from "../../types";
import { ConsistencyStatusBar } from "../consistency/ConsistencyStatusBar";
    ...
    <div className="h-12 bg-panel border-t border-edge flex items-center px-4 gap-3 flex-shrink-0">
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          className="p-1.5 rounded-md text-gold hover:bg-gold/10 transition-colors cursor-pointer"
        >
          {isPlaying ? (
      ...
      <div
        ...
        onClick={(e) => {
          ...
          onPlayheadChange(
            Math.max(0, Math.min(totalDuration, pct * totalDuration))
          );
        }}
      >
            ...
            {shots.map((shot) => (
              <div
                ...
                style={{
                  ...
                  backgroundColor: shot.thumbnailColor,
                  opacity: 0.6,
                }}
              />
            ))}
      ...
      <ConsistencyStatusBar
        ...
        onOpenDetail={onOpenConsistencyDetail}
      />
    </div>
  );
}
